/*
 *  /home/sky/frappe-bench/apps/frappe/frappe/public/js/lib/jquery/jquery.ui.min.js
 */
...
/*
 *  /home/sky/frappe-bench/apps/frappe/frappe/public/js/lib/tag-it.min.js
 */
(function(b) {
    b.widget("ui.tagit", {
        options: {
        ...
        _create: function() {
            ...
            this.tagInput = b('<input type="text" />');
            ...
            this.tagList.addClass("tagit").append(b('<li class="tagit-new"></li>').append(this.tagInput)).click(function(c) {
                var d = b(c.target);
        ...
        createTag: function(a, d, c) {
            ...
            var g = b(this.options.onTagClicked ? '<a class="tagit-label"></a>' : '<span class="tagit-label"></span>').text(a),
                f = b("<li></li>").addClass("tagit-choice").addClass(d).append(g);
...
/*
 *  /home/sky/frappe-bench/apps/frappe/frappe/public/js/lib/bootstrap.min.js
 */
/*!
        ...
        function Parser() {
            ...
            this.get_tag = function(peek) {
                var input_char = '',
                    ...
                    comment = '',
                    space = false,
                    tag_start, tag_end, orig_pos = this.pos,
...
/*
 *  /home/sky/frappe-bench/apps/frappe/frappe/public/js/lib/moment/moment.min.js
 */
//! moment.js
//! version : 2.6.0
...
/*
 *  /home/sky/frappe-bench/apps/frappe/frappe/public/js/lib/moment/moment-timezone.min.js
 */
(function() {
    function a(a) {
        function c(a) {
...
frappe.assets = {
    ...
    exists: function(src) {
        if ('localStorage' in window && localStorage.getItem(src) && (frappe.boot ? !frappe.boot.developer_mode : true))
            return true;
    },
...
frappe.get_shade = function(color, factor) {
    ...
    return get_hex(get_int(color.substr(0, 2)) + factor) + get_hex(get_int(color.substr(2, 2)) + factor) + get_hex(get_int(color.substr(4, 2)) + factor)
}
...
frappe.ui.make_sidebar = function(module){
    ...
    if((frappe.modules[module] && frappe.modules[module].type)=="module"){
        frappe.call({
            ...
            callback: function(r) {
                $(".page-container").css("margin-left","15%")
                $('<div class="page-sidebar-wrapper" style="width: 8%;">\
                 <div class="page-sidebar navbar-collapse collapse" style="margin-top: -7%; background-color:#364150;">\
                   <ul id="sidebar_items" class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="margin-top: 35%;">\
      ...
      //frappe.set_route(frappe.get_module(module).link);
...
frappe.confirm = function(message, ifyes, ifno) {
    var d = new frappe.ui.Dialog({
        ...
        fields: [{
            fieldtype: "HTML",
            options: "<p class='frappe-confirm-message'>" + message + "</p>"
        }],
...
frappe.get_value = function(field, callback) {
    ...
    d.get_input("submit").on("click", function() {
        ...
        if (field.reqd && !values[field.fieldname]) {} else {
            d.hide();
  ...
  ', this.opts));
    ...
    add_button: function(label, click, icon) {
        if (this.appframe) {
            ...
            $button = $('<button class="btn btn-default"></button>').appendTo(this.$w.find('.list-toolbar')).html((icon ? ("<i class='" + icon + "'></i> ") : "") + label).click(click);
            return $button
        }
    },
    ...
    render_results: function(r) {
        ...
        if (r.values && r.values.length) {
            ...
            if (this.start === 0) {
                ...
                var msg = this.get_no_result_message ? this.get_no_result_message() : (this.no_result_message ? this.no_result_message : __("Nothing to show"));
                this.$w.find('.no-result').html(msg).toggle(true);
            }
        }
    ...
    add_row: function(row) {
        return $('<div class="list-row">').data("data", row).appendTo(this.$w.find('.result-list')).get(0);
    },
    refresh: function() {
        this.run();
    },
...
frappe.request.report_error = function(xhr, request_opts) {
   ...
   <pre style="max-height: 300px; margin-top: 7px;">' + exc + '</pre>' + '<p class="text-right"><a class="btn btn-default report-btn">\
    <i class="icon-fixed-width icon-envelope"></i> ' + __("Report this issue") + '</a></p>' + '</div>';
...
function empty_select(s) {
    ...
    if (s) {
        var tmplen = s.length;
        for (var i = 0; i < tmplen; i++) s.options[0] = null;
    }
}
...
frappe.ui.AppFrame = Class.extend({
    ...
    <span class="title-text"></span>\
        ...
        this.$sub_title_area = $('<div class="title-sub hide"></div>').appendTo($center);
        this.setup_iconbar();
        if (title)
    ...
    set_title_left: function(click) {
        return $("<a>").html('<i class="icon-angle-left text-muted" style="margin-right: 10px; \
    font-weight: bold; text-decoration: none;"></i>').on("click", function() {
            click.apply(this);
    ...
    set_title_right: function(txt, click, icon, btn_class) {
        ...
        if (txt) {
            ...
            this.title_right = $("<a class='btn " + btn_class + "'>").html((icon ? '<i class="' + icon + '"></i> ' : "") + txt).click(click).appendTo($right.attr("data-text", txt));
   ...
   <i class="%(icon)s"></i> %(label)s</button>', {
        ...
        })).on("click", click).appendTo(wrapper);
    },
    ...
    add_module_icon: function(module, doctype, onclick, sub_title) {
        ...
        this.get_main_icon(icon).attr("doctype-name", doctype);
    ...
    add_help_button: function(txt) {
        this.add_icon_btn("2", "icon-question-sign", __("Help"), function() {
            msgprint($(this).data('help-text'), 'Help');
        }).data("help-text", txt);
    },
    ...
    add_label: function(label) {
        this.show_form();
        return $("<label class='col-md-1 appframe-only-label'>" + label + " </label>").appendTo(this.parent.find(".appframe-form .container"));
    },
    ...
    add_check: function(label) {
        return $("<div class='checkbox' style='margin-right: 10px; margin-top: 7px; float: left;'><label><input type='checkbox'>" + label + "</label></div>").appendTo(this.parent.find(".appframe-form .container")).find("input");
    },
    add_break: function() {
        this.parent.find(".appframe-form .container").append('<div class="clearfix invisible-xs"></div>');
    },
    add_field: function(df) {
        ...
        f.refresh();
        $(f.wrapper).addClass('col-md-2').css({
            "padding-left": "0px",
            "padding-right": "7px",
        ...
        if (df.fieldtype === "Check") {
            ...
            $(f.wrapper).prepend('<label class="appframe-control-label">' + __(df.label) + '</label>');
        }
        if (df.fieldtype == "Button") {
            $(f.wrapper).find(".appframe-control-label").html("&nbsp;")
            f.$input.addClass("btn-sm").css({
                "width": "100%",
                "margin-top": "-1px"
            });
        }
...
frappe.ui.form.Layout = Class.extend({
    ...
    refresh: function(doc) {
        ...
        $.each(this.fields_list, function(i, fieldobj) {
            if (me.doc) {
                ...
                fieldobj.df = frappe.meta.get_docfield(me.doc.doctype, fieldobj.df.fieldname, me.frm.doc.name);
        ...
        setTimeout(function() {
            ...
            if (!(me.wrapper.find(".frappe-control:visible").length)) {
                $('<div class="alert alert-info empty-form-alert">' + __("This form does not have any input") + '</div>').appendTo(me.wrapper)
            }
        }, 100);
   ...
   <form>\
        ...
        this.section.find(".form-column").removeClass().addClass("form-column").addClass("col-md-" + colspan);
    },
    ...
    make_section: function(df) {
        ...
        this.section = $('<div class="row">').appendTo(this.page);
        ...
        if (df) {
            if (df.label) {
                ...
                var head = $('<h4 class="col-md-12">' + (df.options ? (' <i class="icon-fixed-width text-muted ' + df.options + '"></i> ') : "") + '<span class="section-count-label">' + __(this.labelled_section_count) + "</span>. " + __(df.label) + "</h4>").css({
                    "margin": "15px 0px"
            ...
            if (df.description) {
                $('<div class="col-md-12 small text-muted">' + __(df.description) + '</div>').css("padding-left", "40px").appendTo(this.section);
            }
            if (df.label || df.description) {
                $('<div class="col-md-12"></div>').appendTo(this.section).css({
                    "height": "10px"
                });
            }
        ...
        section.refresh = function() {
            if (!this.df) return;
            $(this).toggle(this.df.hidden || this.df.hidden_due_to_dependency ? false : (cur_frm ? !!cur_frm.get_perm(this.df.permlevel, "read") : true))
        }
        this.column = null;
    ...
    handle_tab: function(doctype, fieldname, shift) {
        var me = this,
            grid_row = null;
        prev = null, fields = me.fields_list, in_grid = false;
    ...
    make: function() {
        if (this.fields) {
            ...
            if (!this.no_submit_on_enter) {
                $(this.body).find("[data-fieldtype='Button']").filter(":first").removeClass("btn-default").addClass("btn-primary");
...
frappe.ui.Button = function(args) {
    ...
    $.extend(this, {
        make: function() {
            ...
            me.btn.args = args;
            me.loading_img = frappe.dom.add(me.btn.args.parent, 'img', '', {
...
frappe.ui.app_icon = {
    get_html: function(app, small) {
        ...
        return '<div class="app-icon' + (small ? " app-icon-small" : "") + '" style="background-color:' + color + '">' + icon + '</div>'
    }
};
frappe.provide('frappe.model');
$.extend(frappe.model, {
    no_value_type: ['Section Break', 'Column Break', 'HTML', 'Table', 'Button', 'Image', 'Fold'],
    layout_fields: ['Section Break', 'Column Break', 'Fold'],
    std_fields_list: ['name', 'owner', 'creation', 'modified', 'modified_by', '_user_tags', '_comments', '_assign', 'docstatus', 'parent', 'parenttype', 'parentfield', 'idx'],
    std_fields: [{
        fieldname: 'name',
        fieldtype: 'Link',
        label: __('ID')
...
$.extend(frappe.meta, {
    ...
    sort_docfields: function(docs) {
        return values(docs).sort(function(a, b) {
            return a.idx - b.idx
        });
    },
    ...
    set_default_values: function(doc, parent_doc) {
        ...
        for (var fid = 0; fid < docfields.length; fid++) {
            ...
            if (!in_list(frappe.model.no_value_type, f.fieldtype) && doc[f.fieldname] == null) {
                ...
                } else if (f.fieldtype == "Select" && f.options && !in_list(["[Select]", "Loading..."], f.options)) {
...
var SUBMIT = "submit",
    ...
    AMEND = "amend";
$.extend(frappe.perm, {
    rights: ["read", "write", "create", "delete", "submit", "cancel", "amend", "report", "import", "export", "print", "email", "set_user_permissions"],
    doctype_perm: {},
        ...
        $.each(meta.permissions || [], function(i, p) {
            if (user_roles.indexOf(p.role) !== -1) {
                ...
                if (permlevel === 0 && cint(p.apply_user_permissions) && p.user_permission_doctypes) {
                    var user_permission_doctypes = p.user_permission_doctypes ? JSON.parse(p.user_permission_doctypes) : null;
    ...
    get_match_rules: function(doctype, ptype) {
        ...
        if (user_permissions && !$.isEmptyObject(user_permissions)) {
            var user_permission_doctypes = me.get_user_permission_doctypes(perm[0].user_permission_doctypes, user_permissions);
...
frappe.workflow = {
    ...
    setup: function(doctype) {
        var wf = frappe.get_list("Workflow", {
    ...
    get_document_state: function(doctype, state) {
        frappe.workflow.setup(doctype);
        return frappe.get_children(frappe.workflow.workflows[doctype], "workflow_document_states", {
            state: state
        })[0];
    },
    ...
    is_read_only: function(doctype, name) {
        ...
        if (state_fieldname) {
            ...
            if (locals[doctype][name].__islocal)
                return false;
            var state = locals[doctype][name][state_fieldname] || frappe.workflow.get_default_state(doctype);
    ...
    get_update_fields: function(doctype) {
        var update_fields = $.unique($.map(frappe.workflow.workflows[doctype].workflow_document_states || [], function(d) {
...
$.extend(frappe.user, {
    ...
    full_name: function(uid) {
        return uid === user ? "You" : frappe.user_info(uid).fullname;
    },
    image: function(uid) {
    ...
    get_desktop_items: function(global) {
        ...
        if (frappe.boot.hidden_modules && modules_list) {
            ...
            var modules_list = $.map(modules_list, function(m) {
                if (hidden_list.indexOf(m) == -1) return m;
                else return null;
            });
        }
...
function prettyDate(time) {
    if (moment) {
        ...
        if (frappe.boot && user_timezone && (user_timezone != system_timezone) && zones[user_timezone] && zones[system_timezone]) {
...
var comment_when = function(datetime) {
    ...
    return '<span class="frappe-timestamp" data-timestamp="' + datetime + '" title="' + timestamp + '">' + prettyDate(datetime) + '</span>';
};
...
frappe.utils = {
    ...
    remove_script_and_style: function(txt) {
        return (!txt || (txt.indexOf("<script>") === -1 && txt.indexOf("<style>") === -1)) ? txt : $("<div></div>").html(txt).find("script,noscript,style,title,meta").remove().end().html();
    },
    ...
    set_intro: function(me, wrapper, txt) {
        if (!me.intro_area) {
            me.intro_area = $('<div class="alert alert-info form-intro-area">').prependTo(wrapper);
        }
        if (txt) {
    ...
    set_footnote: function(me, wrapper, txt) {
        if (!me.footnote_area) {
            me.footnote_area = $('<div class="alert alert-info form-intro-area" style="margin-top: 20px;">').appendTo(wrapper);
        }
        if (txt) {
    ...
    guess_style: function(text, default_style) {
        ...
        if (has_words(["Pending", "Review", "Medium"], text)) {
            ...
            style = "danger";
        } else if (has_words(["Closed", "Finished", "Converted", "Completed", "Confirmed", "Approved", "Yes", "Active"], text)) {
            style = "success";
...
frappe.tools.downloadify = function(data, roles, me) {
    ...
    var _get_data = function() {
        return frappe.tools.to_csv(data);
    };
    ...
    if ((_get_data().length > 200000) || flash_disabled) {
        ...
        var msgobj = msgprint($.format('<p id="{0}"></p><hr><a id="alternative-download">{1}</a>', [id, __('Alternative download link')]));
        msgobj.$wrapper.find("#alternative-download").on("click", function() {
            download_from_server();
        });
...
function get_number_format(currency) {
    if (!global_number_format) {
        global_number_format = frappe.boot.sysdefaults.number_format || frappe.model.get_value(":Currency", frappe.boot.sysdefaults.currency, "number_format") || "#,###.##";
    }
    var number_format;
    if (currency && frappe.boot) {
        number_format = frappe.model.get_value(":Currency", currency, "number_format");
    }
...
frappe.upload = {
   ...
   <p class="small"><a class="action-attach disabled" href="#"><i class="icon-upload"></i> ' + __('Upload a file') + '</a> | <a class="action-link" href="#"><i class="icon-link"></i> ' + __('Attach as web link') + '</a></p>\
   ...
   <button class="btn btn-info btn-upload"><i class="icon-upload"></i> ' + __('Upload') + '</button></div>').appendTo(opts.parent);
    ...
    filter_exists: function(tablename, fieldname, condition, value) {
        for (var i in this.filters) {
            if (this.filters[i].field) {
                ...
                if (f[0] == tablename && f[1] == fieldname && f[2] == condition && f[3] == value) return true;
            }
        }
        return false;
    },
...
frappe.ui.Filter = Class.extend({
  ...
  <div class="col-sm-2 col-xs-3">\
   ...
   <a class="close remove-filter" style="margin-top: 5px;">&times;</a>\
    ...
    set_events: function() {
        ...
        me.$w.find('.condition').change(function() {
            ...
            if (in_list(["in", "like"], condition)) {
                ...
                me.field.desc_area.html((condition === "in" ? __("values separated by commas") : __("use % as wildcard")) + '</div>');
            } else {
    ...
    set_fieldtype: function(df, fieldtype) {
        ...
        if (df.fieldname == "docstatus") {
            df.fieldtype = "Select", df.options = [{
                value: 0,
                label: "Draft"
            }, {
                value: 1,
   ...
   <button class="btn btn-default btn-sm remove-filter"\
   ...
   </button></div>').insertBefore(this.flist.$w.find(".set-filters .new-filter"));
        this.set_filter_button_text();
    ...
    set_filter_button_text: function() {
        ...
        this.$btn_group.find(".toggle-filter").html(repl('<i class="icon-filter"></i> %(label)s %(condition)s "%(value)s"', {
...
frappe.ui.TreeNode = Class.extend({
    ...
    make: function() {
        var me = this;
        this.$a = $('<span class="tree-link">').click(function(event) {
    ...
    make_icon: function() {
        ...
        $(icon_html + ' <a class="tree-label">' + this.label + "</a>").appendTo(this.$a);
    ...
    make_toolbar: function() {
        ...
        $.each(this.tree.toolbar, function(i, item) {
            ...
            var link = $("<a class='tree-toolbar-item'>").html(label).appendTo(me.toolbar).click(function() {
                item.click(me, this);
                return false;
            });
    ...
    addnode: function(data) {
        ...
        if (this.tree.drop) $li.draggable({
            revert: true
        });
    ...
    toggle_node: function(callback) {
        ...
        this.tree.$w.find('.selected').removeClass('selected');
            ...
            callback: function(r) {
                ...
                if (r.message) {
                    $.each(r.message, function(i, v) {
                        node = me.addnode(v);
                        node.$a.data('node-data', v).data('node', node);
                    });
                }
                if (!me.expanded)
...
frappe.views.Container = Class.extend({
   ...
   page creation, switching",
    ...
    add_page: function(label, onshow, onhide) {
        var page = $('<div class="content page-container"></div>').attr('id', "page-" + label).attr("data-page-route", label).toggle(false).appendTo(this.container).get(0);
        if (onshow)
...
frappe.show_not_found = function(page_name) {
    frappe.show_message_page(page_name, '<i class="icon-exclamation-sign"></i> ' + __("Not Found"), __("Sorry we were unable to find what you were looking for."));
}
frappe.show_not_permitted = function(page_name) {
    frappe.show_message_page(page_name, '<i class="icon-exclamation-sign"></i> ' + __("Not Permitted"), __("Sorry you are not permitted to view this page."));
}
...
frappe.views.DocListView = frappe.ui.Listing.extend({
    init: function(opts) {
        ...
        this.label = (this.label.toLowerCase().substr(-4) == 'list') ? __(this.label) : (__(this.label) + ' ' + __('List'));
        this.make_page();
        this.setup();
        var me = this;
    ...
    make_page: function() {
        ...
        this.$page = $(this.page).css({
            "min-height": "400px"
        });
        $('<div class="frappe-list-area" style="margin-bottom: 25px;">\
   <div class="help">' + __('Loading') + '...</div></div>').appendTo(this.$page.find(".layout-main-section"));
        this.$page.find(".layout-main-section").addClass("listview-main-section").parent().css({
            "margin-top": "-15px"
        });
        ...
        this.appframe.set_title_left(function() {
            frappe.set_route(frappe.listview_parent_route[me.doctype] || frappe.get_module(module).link);
        });
    ...
    setup: function() {
        ...
        this.$page.find('.frappe-list-area').empty(), this.setup_listview();
        ...
        this.init_filters();
        this.$page.find(".show_filters").css({
            "padding": "15px",
            "margin": "0px -15px"
        });
        this.$w.on("render-complete", function() {
            if (me.data.length === 1 && frappe.get_prev_route()[2] !== me.data[0].name) {
    ...
    set_sidebar_height: function() {
        ...
        if (h_side > h_main)
            this.$page.find(".layout-main-section").css({
                "min-height": h_side
            });
    },
    setup_filterable: function() {
        ...
        this.$page.on("click", ".filterable", function(e) {
            ...
            $.each(filters, function(i, f) {
                ...
                added = added || me.filter_list.add_filter(me.doctype, f[0], f[1], f.slice(2).join(","));
            });
            added && me.run();
        })
    },
        ...
        if (match_rules_list.length) {
            ...
            $.each(match_rules_list, function(i, match_rules) {
                ...
                if (match_text.length) {
                    var txt = "<ul>" + $.map(match_text, function(txt) {
                        return "<li>" + txt + "</li>"
                    }).join("") + "</ul>";
            ...
            if (or_match_text.length) {
                frappe.utils.set_footnote(this, this.$page.find(".layout-main-section"), "<p style=\"margin-bottom: 7px;\">" + __("Additional filters based on User Permissions, having:") + "</p>" + or_match_text.join("<p class=\"strong\" \
      style=\"margin-left: 40px; margin-top: 7px; margin-bottom: 7px;\">" + __("or") + "</p>") + "<p class=\"text-muted\" style=\"margin-top: 15px;\">" + __("Note: fields having empty value for above criteria are not filtered out.") + "</p>");
    ...
    make_no_result: function() {
        var new_button = frappe.boot.user.can_create.indexOf(this.doctype) != -1 ? ('<hr><p><button class="btn btn-primary" \
   ...
   <p>' + __("No {0} found", [__(this.doctype)]) + '</p>' + new_button + '</div>';
    ...
    init_minbar: function() {
        var me = this;
        this.appframe.add_icon_btn("2", 'icon-tag', __('Show Tags'), function() {
            me.toggle_tags();
        });
        this.$page.on("click", ".list-tag-preview", function() {
            me.toggle_tags();
        });
        this.appframe.add_icon_btn("2", 'icon-user', __('Assigned To Me'), function() {
        ...
        if (this.can_delete || this.listview.settings.selectable) {
            this.appframe.add_icon_btn("2", 'icon-ok', __('Select All'), function() {
                me.$page.find('.list-delete').prop("checked", me.$page.find('.list-delete:checked').length ? false : true);
            });
            this.appframe.add_icon_btn("2", 'icon-trash', __('Delete'), function() {
                me.delete_items();
            });
        }
        ...
        if (frappe.model.can_set_user_permissions(this.doctype)) {
            this.appframe.add_icon_btn("2", "icon-shield", __("User Permissions Manager"), function() {
        ...
        if (in_list(user_roles, "System Manager")) {
            this.appframe.add_icon_btn("2", "icon-lock", __("Role Permissions Manager"), function() {
                frappe.route_options = {
                    doctype: me.doctype
                };
    ...
    delete_items: function() {
        ...
        if (!dl.length)
            return;
        frappe.confirm(__('This is permanent action and you cannot undo. Continue?'), function() {
            me.set_working(true);
            return frappe.call({
                method: 'frappe.widgets.reportview.delete_items',
                args: {
                    items: $.map(dl, function(d, i) {
                        return d.name
                    }),
                    doctype: me.doctype
                },
...
frappe.views.SidebarStats = Class.extend({
    ...
    get_stats: function() {
        ...
        return frappe.call({
            ...
            callback: function(r) {
                ...
                if (me.stats.length) {
                    $('<a class="small"><i class="icon-refresh"></i> ' + __('Refresh') + '</a>').css({
                        "margin-top": "15px",
                        "display": "inline-block"
                    }).click(function() {
                        me.reload_stats();
                        return false;
                    }).appendTo($('<div class="stat-wrapper">').appendTo(me.wrapper));
                }
    ...
    render_stat: function(field, stat) {
        var me = this;
        var show_tags = '<a class="list-tag-preview small" style="margin-left: 7px;">' + __("Show tags") + '</a>';
        if (!stat || !stat.length) {
            if (field === '_user_tags') {
     ...
     <div class="side-panel-body">\
      <div class="text-muted small"><i>' + __('No records tagged.') + '</i><br>' + '</div>\
...
frappe.views.moduleview.ModuleView = Class.extend({
    ...
    prepare: function(wrapper, module) {
        ...
        wrapper.appframe.set_title_left(function() {
            frappe.set_route("");
        });
    ...
    <a><i class="' + d.icon + ' icon-fixed-width"></i><span class="hidden-xs"> ' + __(d.label) + '</span></a></li>').attr("data-label", d._label).attr("data-section-label", d.label).appendTo($sections);
            var $content = $('<div class="panel panel-default"></div>').toggle(false).attr("data-content-label", d._label).appendTo($layout.find(".contents"));
            $('<div class="panel-heading">').appendTo($content).html('<i class="' + d.icon + '"></i> ' + d.label);
    ...
    add_items: function(d, $layout) {
        ...
        $.each(d.items, function(i, item) {
            ...
            if ((item.type === "doctype" && frappe.model.can_read(item.name)) || (item.type === "page" && frappe.boot.page_info[item.name]) || (item.type === "report" && frappe.model.can_get_report(item.doctype))) {
                if (!item.label) {
      ...
      <div class="col-sm-6 text-muted list-item-description">%(description)s</div>\
                ...
                if (show_count) {
                    $(repl('<span data-doctype-count="%(doctype)s" style="margin-left: 2px;"></span>', {
                        doctype: item.doctype || item.name
                    })).appendTo($list_item.find(".list-item-name"));
                }
            }
        });
    },
    ...
    show_counts: function($layout) {
        ...
        $.each(this.item_count, function(label, counts) {
            ...
            $.each(counts, function(doctype, count) {
                $layout.find("[data-doctype-count='" + doctype + "']").html(count).addClass("badge badge-count pull-right").css({
                    cursor: "pointer"
                });
            });
        });
            ...
            $.each(frappe.boot.notification_info.open_count_doctype, function(doctype, count) {
                if (count && in_list(me.doctypes, doctype)) {
                    $('<span>').css({
                        "cursor": "pointer",
                        "margin-right": "0px"
                    }).addClass("badge badge-important pull-right").html(count).attr("data-doctype", doctype).insertAfter($layout.find("[data-doctype-count='" + doctype + "']"));
                }
            })
        }
    },
...
frappe.views.ListView = Class.extend({
    ...
    set_fields: function() {
        ...
        $.each(['name', 'owner', 'docstatus', '_user_tags', '_comments', 'modified', 'modified_by', '_assign'], function(i, fieldname) {
            add_field(fieldname);
        })
    ...
    render_timestamp_and_comments: function(row, data) {
        var comments = data._comments ? JSON.parse(data._comments) : [],
            tags = $.map((data._user_tags || "").split(","), function(v) {
                return v ? v : null;
            }),
            assign = data._assign ? JSON.parse(data._assign) : [],
            me = this;
        if (me.title_field && data[me.title_field] !== data.name) {
            $('<div class="list-doc-name">').appendTo(row).css({
                "left": me.title_offset_left
            }).html('<a href="#Form/' + data.doctype + '/' + data.name + '">#' + data.name + "</a>");
        }
        $(row).find(".list-timestamp").remove();
        var timestamp_and_comment = $('<div class="list-timestamp">').appendTo(row).html(frappe.render(frappe.templates.list_info_template, {
            "tags": tags,
            "comments": comments,
            "assign": assign,
            "data": data,
   ...
   <div class="col-xs-12">\
    ...
    make_column: function(body, colspan) {
        var col = $("<div class='col'>").appendTo(body).addClass("col-sm-" + cint(colspan)).addClass("col-xs-" + (cint(colspan) + 2)).css({
            "white-space": "nowrap",
    ...
    get_avatar_and_id: function(data, without_workflow) {
     ...
     style="margin-right: 5px;">';
        ...
        html += frappe.avatar(user_for_avatar, false, __("Modified by") + ": " + frappe.user_info(user_for_avatar).fullname)
    ...
    title="%(docstatus_title)s"></i></span>', data);
        ...
        var full_title = data[this.title_field || "name"],
            title = full_title;
   ...
   href="#Form/%(doctype)s/%(name)s" title="%(full_title)s">%(title)s</a>', {
    ...
    render_column: function(data, parent, opts) {
        ...
        if (typeof opts.content == 'function') {
        ...
        } else if (opts.content == 'check') {} else if (opts.type == 'bar-graph' || opts.type == "percent") {
            ...
            $("<span>").html(frappe.datetime.str_to_user(data[opts.content])).css({
                "color": "#888"
            }).appendTo(parent);
        } else if (opts.type == "image") {
            data[opts.content] = data[opts.df.options];
            if (data[opts.content])
                $("<img>").attr("src", frappe.utils.get_file_link(data[opts.content])).css({
                    "max-width": "100%",
                    "max-height": "30px"
                }).appendTo(parent);
            ...
            $("<span>" + data[opts.content] + "</span>").css({
                "cursor": "pointer"
            }).addClass("label").addClass("filterable").addClass(label_class).attr("data-filter", opts.df.fieldname + ",=," + data[opts.content]).appendTo(parent.css({
                "overflow": "hidden"
            }));
        } else if (opts.type == "link" && data[opts.content]) {
            $("<span>").html(frappe.format(data[opts.content], opts.df, null, data)).appendTo(parent.css({
                "overflow": "hidden"
            })).click(function() {
                me.doclistview.set_filter($(this).attr("data-fieldname"), $(this).attr("data-value"));
                return false;
            }).attr("data-fieldname", opts.content).attr("data-value", data[opts.content]).find("a").removeAttr("href");
        ...
        if (!in_list(["avatar", "_user_tags", "check"], opts.content)) {
            if ($(parent).attr("title") == undefined) {
                $(parent).attr("title", (opts.title || opts.content) + ": " + (data[opts.content] || __("Not Set")))
            }
            $(parent).tooltip();
        }
    },
    show_hide_check_column: function() {
        if (!this.doclistview.can_delete) {
            this.columns = $.map(this.columns, function(v, i) {
                if (v.content != 'check') return v
            });
        }
    },
...
frappe.views.ReportViewPage = Class.extend({
        ...
        frappe.model.with_doctype(this.doctype, function() {
            ...
            if (me.docname) {
                frappe.model.with_doc('Report', me.docname, function(r) {
                    me.page.reportview.set_columns_and_filters(JSON.parse(frappe.get_doc("Report", me.docname).json));
    ...
    make_report_view: function() {
        ...
        this.page.appframe.set_title_left(function() {
            frappe.set_route((frappe.get_module(module) || {}).link);
        });
...
frappe.views.ReportView = frappe.ui.Listing.extend({
    ...
    set_init_columns: function() {
        ...
        if (!columns) {
            ...
            $.each(frappe.meta.docfield_list[this.doctype], function(i, df) {
                if ((df.in_filter || df.in_list_view) && df.fieldname != 'naming_series' && !in_list(frappe.model.no_value_type, df.fieldtype)) {
    ...
    get_order_by: function() {
        var order_by = this.get_selected_table_and_column(this.sort_by_select) + ' ' + this.sort_order_select.val();
        if (this.sort_by_next_select.val()) {
            order_by += ', ' + this.get_selected_table_and_column(this.sort_by_next_select) + ' ' + this.sort_order_next_select.val();
        }
        return order_by;
    },
            ...
            coldef = {
                ...
                formatter: function(row, cell, value, columnDef, dataContext) {
                    ...
                    if (docfield.fieldtype === "Link" && docfield.fieldname !== "name") {
                        docfield.link_onclick = repl('frappe.container.page.reportview.set_filter("%(fieldname)s", "%(value)s").page.reportview.run()', {
    ...
    render_list: function() {
        ...
        this.grid = new Slick.Grid(grid_wrapper.css('border', '1px solid #ccc').css('border-top', '0px').get(0), this.dataView, columns, options);
    ...
    edit_cell: function(row, docfield) {
        if (docfield.fieldname !== "idx" && frappe.model.std_fields_list.indexOf(docfield.fieldname) !== -1) {
    ...
    make_sorter: function() {
        var me = this;
        this.sort_dialog = new frappe.ui.Dialog({
    ...
    make_delete: function() {
        ...
        if (this.can_delete) {
            $(this.page).on("click", "input[type='checkbox'][data-row]", function() {
                me.data[$(this).attr("data-row")]._checked = this.checked ? true : false;
            });
...
frappe.ui.ColumnPicker = Class.extend({
   ...
   </div>').appendTo($(this.dialog.body).find('.column-list'));
        var fieldselect = new frappe.ui.FieldSelect({
                parent: w,
                doctype: this.doctype
            }),
            me = this;
        fieldselect.$select.css({
            "display": "inline"
        });
        fieldselect.$select.css({
            width: '70%',
...
frappe.views.Gantt = Class.extend({
    init: function(opts) {
        ...
        this.make_page();
        frappe.route_options ? this.set_filters_from_route_options() : this.refresh();
    },
    make_page: function() {
        var module = locals.DocType[this.doctype].module,
            me = this;
        ...
        this.appframe.set_title_right(__("Refresh"), function() {
            me.refresh();
        }, "icon-refresh")
        this.appframe.add_field({
            fieldtype: "Date",
            label: "From",
            fieldname: "start",
    ...
    refresh: function() {
        var parent = $(this.page).find(".layout-main").empty().css('min-height', '300px').html('<div class="alert alert-info">Loading...</div>');
        var me = this;
        return frappe.call({
    ...
    get_filters: function() {
        ...
        if (this.filters) {
            $.each(this.filters, function(i, df) {
                filter_vals[df.fieldname || df.label] = me.appframe.fields_dict[df.fieldname || df.label].get_parsed_value();
            });
        }
        return filter_vals;
    },
                ...
                source.push({
                    ...
                    values: [{
                        ...
                        customClass: {
                            ...
                            'success': 'ganttGreen',
                            '': 'ganttGray'
                        }[me.style_map ? me.style_map[v.status] : frappe.utils.guess_style(v.status, "standard")],
                        dataObj: v
                    }]
                })
            }
  ...
  <div class="results" style="display: none;">\
   ...
   <p class="text-muted"><br>\
    ...
    make_toolbar: function() {
        ...
        this.appframe.add_button(__('Export'), function() {
            me.export_report();
        }, "icon-download");
    ...
    setup_filters: function() {
        ...
        $.each(frappe.query_reports[this.report_name].filters || [], function(i, df) {
            if (df.fieldtype === "Break") {
                ...
                if (df.fieldtype == "Check") {
                    $(f.wrapper).find("input[type='checkbox']").css({
                        "float": "None",
                        "margin-left": "0px"
                    });
                }
    ...
    export_report: function() {
        ...
        var result = $.map(frappe.slickgrid_tools.get_view_data(this.columns, this.dataView), function(row) {
            return [row.splice(1)];
        });
...
frappe.views.GridReport = Class.extend({
    init: function(opts) {
        ...
        this.appframe.parent.find(".appframe").css({
            "padding-top": "0px"
        });
        if (this.filters) {
            this.make_filters();
   ...
   background-color: #eee; margin-top: 15px;'>").appendTo(this.wrapper);
        this.id = frappe.dom.set_unique_id(this.grid_wrapper.get(0));
        $('<div style="margin: 10px 0px; display: none" class="show-zero">\
    <input type="checkbox"> ' + __('Show rows with zero values') + '</div>').appendTo(this.wrapper);
        this.bind_show();
    ...
    export: function() {
        frappe.tools.downloadify(frappe.slickgrid_tools.get_view_data(this.columns, this.dataView), ["Report Manager", "System Manager"], this);
        return false;
    },
   ...
   <i class="icon icon-share" style="cursor: pointer;"></i></a>', {
    ...
    make_date_range_columns: function() {
        ...
        $.each(this.columns, function(i, col) {
            col.name = me.columns[i + 1] ? dateutil.str_to_user(dateutil.add_days(me.columns[i + 1].id, -1)) : dateutil.str_to_user(me.to_date);
        });
    },
        ...
        this.wrapper.find('.plot').bind("plothover", function(event, pos, item) {
            if (item) {
                if (me.previousPoint != item.dataIndex) {
                    ...
                    showTooltip(item.pageX, item.pageY, me.get_tooltip_text(item.series.label, item.datapoint[0], item.datapoint[1]));
                }
            } else {
                $("#" + me.tooltip_id).remove();
        ...
        $.each(this.data, function(i, item) {
            if (item.checked) {
                ...
                data[data.length - 1].data = [
                    [dateutil.str_to_obj(me.from_date).getTime(), item.opening]
                ].concat(data[data.length - 1].data);
            }
        });
...
frappe.views.TreeGridReport = frappe.views.GridReportWithPlot.extend({
   ...
   <p><button class="btn btn-info"> {3}</button>', [__('Select To Download:'), __('With Groups'), __('With Ledgers'), __('Download')]));
        var me = this;
...
frappe.views.CommunicationList = Class.extend({
    init: function(opts) {
        ...
        if (!this.list)
            this.list = frappe.get_list("Communication", {
   ...
   <div style='margin-bottom: 15px; margin-left: 40px;'>\
    ...
    prepare: function(doc) {
        ...
        doc._sender_id = doc.sender.indexOf("<") !== -1 ? strip(doc.sender.split("<")[1].split(">")[0]) : doc.sender;
   ...
   </div></div>', doc)).appendTo(this.body);
...
frappe.views.CommunicationComposer = Class.extend({
    ...
    make: function() {
        ...
        this.dialog = new frappe.ui.Dialog({
            ...
            fields: [{
                ...
                label: __("Send As Email"),
                fieldtype: "Check",
                fieldname: "send_email"
            }, {
                label: __("Communication Medium"),
                fieldtype: "Select",
    ...
    setup_standard_reply: function() {
        ...
        this.dialog.get_input("standard_reply").on("change", function() {
            ...
            var prepend_reply = function() {
                ...
                content_field.set_input(frappe.standard_replies[standard_reply] + "<br><br>" + content);
            }
    ...
    setup_last_edited_communication: function() {
        ...
        this.dialog.onshow = function() {
            if (cur_frm && cur_frm.docname && (frappe.last_edited_communication[cur_frm.doctype] || {})[cur_frm.docname]) {
    ...
    setup_attach: function() {
     ...
     data-file-name='%(name)s'> %(file_name)s</label> <a href='%(file_url)s' target='_blank' class='text-muted'> <i class='icon-share'></i></p>", f)).appendTo(attach)
            });
        }
    },
    ...
    setup_earlier_reply: function() {
        var fields = this.dialog.fields_dict;
        var comm_list = (cur_frm && cur_frm.communication_view) ? cur_frm.communication_view.list : [];
        ...
        var reply = (this.message || "") + "<p></p>" + signature;
        if (comm_list.length > 0) {
            fields.content.set_input(reply + "<p></p>" + "-----" + __("In response to") + "-----" + "<p style='font-size: 11px; color: #888'>" + __("Please reply above this line or remove it if you are replying below it") + "</p><br><br>" + comm_list[0].content);
        } else {
    ...
    setup_autosuggest: function() {
        ...
        $(this.dialog.fields_dict.recipients.input).bind("keydown", function(event) {
            ...
            source: function(request, response) {
                return frappe.call({
                    ...
                    callback: function(r) {
                        response($.ui.autocomplete.filter(r.cl || [], extractLast(request.term)));
                    }
                });
            },
...
frappe.form.formatters = {
    ...
    Currency: function(value, docfield, options, doc) {
        ...
        return frappe.form.formatters._right((value == null || value === "") ? "" : format_currency(value, currency, docfield.precision || null), options);
    },
    ...
    Link: function(value, docfield, options) {
        ...
        if (docfield && docfield.link_onclick) {
            ...
            return repl('%(icon)s<a href="#Form/%(doctype)s/%(name)s">%(label)s</a>', {
                ...
                label: value,
                icon: (options && options.no_icon) ? "" : ('<i class="icon-fixed-width ' + frappe.boot.doctype_icons[doctype] + '"></i> ')
            });
        } else {
            return value;
        }
...
frappe.get_format_helper = function(doc) {
    var helper = {
        get_formatted: function(fieldname) {
            ...
            return frappe.format(doc[fieldname], df, {
                inline: 1
            }, doc);
        }
    };
...
frappe.search = {
    setup: function() {
        $("#navbar-search").autocomplete({
            ...
            return $('<li></li>').data('item.autocomplete', d).html('<a><p>' + html + '</p></a>').appendTo(ul);
        };
...
frappe.search.verbs = [function(txt) {
    var route = frappe.get_route();
...
frappe.ui.toolbar.RecentDocs = Class.extend({
   ...
   <a href="#Form/%(dt_encoded)s/%(dn_encoded)s">\
    ...
    %(dnshow)s</span>\
            ...
            dt_encoded: encodeURIComponent(dt),
            dn_encoded: encodeURIComponent(dn),
            dt: dt,
            dn: dn,
            dnshow: __(dn),
            icon: frappe.boot.doctype_icons[dt]
        });
        if (on_top) {
    ...
    remove: function(dt, dn) {
        $(repl('#toolbar-recent li[data-docref="%(dt)s/%(dn)s"]', {
            dt: dt,
            dn: dn
        })).remove();
    },
...
frappe.ui.toolbar.Bookmarks = Class.extend({
   ...
   <ul class="dropdown-menu" id="toolbar-bookmarks">\
    <li class="divider"></li>\
    <li><a href="#" id="add-bookmark-link"><i class="icon-plus"></i> ' + __('Add Bookmark') + '</a></li>\
    <li style="display: none" id="remove-bookmark-link"><a href="#"><i class="icon-minus"></i> ' + __('Remove Bookmark') + '</a></li>\
   </ul>\
  </li>');
        this.setup();
    },
    ...
    bookmarked: function(route) {
        return frappe.utils.filter_dict(this.bookmarks, {
            "route": route
        }).length;
    },
    save: function() {
    ...
    remove: function(route) {
        ...
        $(repl('#toolbar-bookmarks li a[href="#%(route)s"]', {
            route: route
        })).parent().remove();
    },
});;
  ...
  <p class='text-muted'>&copy; 2014 Web Notes Technologies Pvt. Ltd and contributers </p> \
        ...
        var show_versions = function(versions) {
            ...
            $.each(keys(versions).sort(), function(i, key) {
                var v = versions[key];
                $($.format('<p><b>{0}:</b> v{1}<br><span class="text-muted">{2}</span></p>', [v.title[0], v.version, v.description[0]])).appendTo($wrap);
            });
...
frappe.ui.toolbar.Toolbar = Class.extend({
    ...
    make_admin_nav: function(){
        $('#before_header').after('<div class="navbar navbar-inverse navbar-fixed-top">\
...
$.extend(frappe.ui.toolbar, {
    add_dropdown_button: function(parent, label, click, icon) {
        ...
        return $('<li class="custom-menu"><a><i class="icon-fixed-width ' + icon + '"></i> ' + label + '</a></li>').insertBefore(menu.find(".divider")).find("a").click(function() {
            click.apply(this);
        });
    },
...
frappe.ui.toolbar.update_notifications = function() {
    ...
    <i class="icon-fixed-width %(icon)s"></i> %(module)s </a></li>', {
            ...
            })).appendTo("#navbar-notification").find("a").attr("data-module", module).css({
                "min-width": "200px"
            }).on("click", function() {
    ...
    <i class="icon-fixed-width %(icon)s"></i> %(doctype)s </a></li>', {
                ...
                count: count
            })).appendTo("#navbar-notification").find("a").attr("data-doctype", doctype).css({
                "min-width": "200px"
            }).on("click", function() {
                frappe.views.show_open_count_list(this);
            });
    ...
    $(".navbar-new-comments").html(total).toggleClass("navbar-new-comments-true", total ? true : false);
}
...
frappe.ui.toolbar.show_banner = function(msg) {
    $banner = $('<div class="toolbar-banner">' + msg + '<a class="close">&times;</a></div>').prependTo($('header .navbar'));
    $("body").css({
        "padding-top": "70px"
    });
...
bsEditor = Class.extend({
    ...
    clean_html: function() {
        ...
        if (this.options.remove_typography) {
            ...
            tmp.find("*").removeAttr("style").removeAttr("font");
            html = tmp.html();
        }
        return html;
    },
    init_file_drops: function() {
        var me = this;
        this.editor.on('dragenter dragover', false).on('drop', function(e) {
...
bsEditorToolbar = Class.extend({
    init: function(options, parent, editor) {
        ...
        this.editor = editor;
        this.inline = !!parent;
        this.options.toolbar_style = $.extend((this.inline ? this.inline_style : this.fixed_style), this.options.toolbar_style || {});
        this.make(parent);
   ...
   <div class="btn-toolbar" data-role="editor-toolbar" style="margin-bottom: 7px;">\
    ...
    setup_image_button: function() {
        var me = this;
        this.file_input = this.toolbar.find('input[type="file"]').css({
            'opacity': 0,
            'position': 'absolute',
            'left': 0,
            'width': 0,
    ...
    show: function() {
        ...
        if (!this.inline) {
            $("body").animate({
                "padding-top": this.toolbar.outerHeight()
            }, {
                complete: function() {
                    me.toolbar.css("z-index", 1001);
                }
            });
        }
    },
    ...
    bind_events: function() {
        ...
        this.toolbar.find('[data-toggle=dropdown]').click(function() {
            me.restore_selection()
        });
...
_f.Frm = function(doctype, parent, in_form) {
    ...
    this.sections = [];
    this.grids = [];
    this.cscript = new frappe.ui.form.Controller({
        frm: this
    });
    this.pformat = {};
    this.fetch_dict = {};
...
_f.Frm.prototype.setup = function() {
    ...
    this.layout_main = $(this.wrapper).find(".layout-main").css({
        "padding-bottom": "0px"
    }).get(0);
...
_f.Frm.prototype.print_doc = function() {
    ...
    this.print_preview.print_sel.empty().add_options(this.print_preview.print_formats).trigger("change");
...
_f.Frm.prototype.watch_model_updates = function() {
    ...
    $.each(frappe.get_children("DocType", me.doctype, "fields", {
        fieldtype: "Table"
    }), function(i, df) {
...
_f.Frm.prototype.refresh_field = function(fname) {
    cur_frm.fields_dict[fname] && cur_frm.fields_dict[fname].refresh && cur_frm.fields_dict[fname].refresh();
}
    ...
    var after_save = function(r) {
        ...
        if (frappe._from_link) {
            if (me.doctype === frappe._from_link.df.options) {
                ...
                setTimeout(function() {
                    scroll(0, frappe._from_link_scrollY);
                }, 100);
            }
...
refresh_field = function(n, docname, table_field) {
    ...
    if (table_field && cur_frm.fields_dict[table_field].grid.grid_rows_by_docname) {
...
set_missing_values = function(doc, dict) {
    ...
    if (fields_to_set) {
        set_multiple(doc.doctype, doc.name, fields_to_set);
    }
}
...
_f.Frm.prototype.get_formatted = function(fieldname) {
    return frappe.format(this.doc[fieldname], frappe.meta.get_docfield(this.doctype, fieldname, this.docname), {
        no_icon: true
    }, this.doc);
};
frappe.provide("frappe.ui.form");
frappe.ui.form.Toolbar = Class.extend({
    ...
    set_title: function() {
        ...
        if (this.frm.meta.issingle) {
            this.appframe.set_title_left(function() {
                frappe.set_route(frappe.get_module(me.frm.meta.module).link);
            });
        } else {
            this.appframe.set_title_left(function() {
                me.frm.list_route ? frappe.set_route(me.frm.list_route) : frappe.set_route("List", me.frm.doctype);
            });
        }
    },
    ...
    make_file_menu: function() {
        ...
        $(".custom-menu").remove();
        if (p[CREATE]) {
            this.appframe.add_dropdown_button("File", __("New") + " " + __(me.frm.doctype), function() {
    ...
    show_title_as_dirty: function() {
        if (this.frm.save_disabled)
            return;
        this.appframe.get_title_area().toggleClass("text-warning", this.frm.doc.__unsaved ? true : false)
        this.set_title();
...
frappe.ui.form.InfoBar = Class.extend({
    ...
    make: function() {
        ...
        this.$reload = this.appframe.add_icon_btn("2", "icon-refresh", __("Reload Page"), function() {
            me.frm.reload_doc();
        })
        this.$timestamp = this.appframe.add_icon_btn("2", "icon-user", __("Creation / Modified By"), function() {
            msgprint("Created By: " + frappe.user.full_name(me.frm.doc.owner) + "<br>" + "Created On: " + comment_when(me.frm.doc.creation) + "<br>" + "Last Modified By: " + frappe.user.full_name(me.frm.doc.modified_by) + "<br>" + "Last Modifed On: " + comment_when(me.frm.doc.modified))
        });
        ...
        this.$links = this.appframe.add_icon_btn("2", "icon-link", __("Linked With"), function() {
            me.frm.toolbar.show_linked_with();
        });
        if (!me.frm.meta.issingle && frappe.model.can_set_user_permissions(me.frm.doctype, me.frm)) {
            this.$user_properties = this.appframe.add_icon_btn("2", "icon-shield", __("User Permissions Manager"), function() {
                frappe.route_options = {
        ...
        if (frappe.model.can_print(me.frm.doctype, me.frm)) {
            this.$print = this.appframe.add_icon_btn("2", "icon-print", __("Print"), function() {
                me.frm.print_doc();
            });
        }
        if (frappe.model.can_email(me.frm.doctype, me.frm)) {
            this.$print = this.appframe.add_icon_btn("2", "icon-envelope", __("Email"), function() {
                me.frm.email_doc();
            });
        }
        if (!this.frm.meta.issingle) {
            this.$prev = this.appframe.add_icon_btn("2", "icon-arrow-left", __("Previous Record"), function() {
                me.go_prev_next(true);
            });
            this.$next = this.appframe.add_icon_btn("2", "icon-arrow-right", __("Next Record"), function() {
    ...
    highlight_items: function() {
        ...
        if (this.docinfo.comments && this.docinfo.comments.length) {
            ...
            this.$comments.popover({
                title: __("Last Comment"),
                content: last.comment + '<p class="text-muted small">By ' + frappe.user_info(last.comment_by).fullname + " / " + comment_when(last.creation) + '</p>',
                trigger: "hover",
                html: true,
                placement: "bottom"
            });
...
frappe.ui.form.Dashboard = Class.extend({
    init: function(opts) {
        $.extend(this, opts);
        this.wrapper = $('<div class="form-dashboard row"></div>').css({
            "margin-bottom": "20px",
            "padding-bottom": "10px"
    ...
    set_headline: function(html) {
        if (!this.headline)
            this.headline = $('<div class="form-headline col-md-12">').prependTo(this.body);
   ...
   <div class="alert alert-info alert-badge">\
    ...
    set_badge_count: function(data) {
        ...
        $.each(data, function(doctype, count) {
            $(me.wrapper).find(".alert-badge[data-doctype='" + doctype + "'] .badge").html(cint(count));
        });
    },
    ...
    make_progress_chart: function(title) {
        ...
        var progress_chart = $('<div class="progress-chart" title="' + title + '"></div>').appendTo(progress_area);
        var n_charts = progress_area.find(".progress-chart").length,
            cols = Math.floor(12 / n_charts);
        progress_area.find(".progress-chart").removeClass().addClass("progress-chart col-md-" + cols);
...
frappe.ui.form.ScriptManager = Class.extend({
    ...
    make: function(ControllerClass) {
        this.frm.cscript = $.extend(this.frm.cscript, new ControllerClass({
            frm: this.frm
        }));
    },
        ...
        if (frappe.ui.form.handlers[doctype] && frappe.ui.form.handlers[doctype][event_name]) {
            $.each(frappe.ui.form.handlers[doctype][event_name], function(i, fn) {
                handlers.push(function() {
                    fn(me.frm, doctype, name)
                });
            });
        }
        if (this.frm.cscript[event_name]) {
            handlers.push(function() {
                me.frm.cscript[event_name](me.frm.doc, doctype, name);
            });
        }
...
function make_field(docfield, doctype, parent, frm, in_grid, hide_label) {
...
frappe.ui.form.Control = Class.extend({
    ...
    get_status: function(explain) {
        if (!this.doctype)
            return "Write";
        return frappe.perm.get_field_display_status(this.df, locals[this.doctype][this.docname], this.perm || this.frm.perm, explain);
    },
    refresh: function() {
        this.disp_status = this.get_status();
        this.$wrapper && this.$wrapper.toggle(this.disp_status != "None") && this.$wrapper.trigger("refresh");
    },
    get_doc: function() {
...
frappe.ui.form.ControlImage = frappe.ui.form.Control.extend({
    make: function() {
        this._super();
        var me = this;
        this.$wrapper = $("<div class='row'><div class='col-xs-4'></div></div>").appendTo(this.parent).css({
            "max-width": "600px",
            "margin": "0px"
        });
        this.$body = $("<div class='col-xs-8'>").appendTo(this.$wrapper).css({
            "margin-bottom": "10px",
            "max-width": "100%"
        })
        this.$wrapper.on("refresh", function() {
            ...
            if (me.df.options && me.frm.doc[me.df.options]) {
                me.$img = $("<img src='" + me.frm.doc[me.df.options] + "' style='max-width: 100%;'>").appendTo(me.$body);
            } else {
                me.$buffer = $("<div class='missing-image'><i class='icon-camera'></i></div>").appendTo(me.$body)
            }
            return false;
        });
...
frappe.ui.form.ControlInput = frappe.ui.form.Control.extend({
    ...
    <div class="form-group row" style="margin: 0px">\
     <label class="control-label small col-xs-' + (this.horizontal ? "4" : "12") + '" style="padding-right: 0px;"></label>\
    ...
    set_disp_area: function() {
        this.disp_area && $(this.disp_area).html(frappe.format(this.value, this.df, {
            no_icon: true
...
frappe.ui.form.ControlData = frappe.ui.form.ControlInput.extend({
    ...
    input_type: "text",
    make_input: function() {
        this.$input = $("<" + this.html_element + ">").attr("type", this.input_type).addClass("input-with-feedback form-control").prependTo(this.input_area)
...
frappe.ui.form.ControlCurrency = frappe.ui.form.ControlFloat.extend({
    format_for_input: function(value) {
        var formatted_value = format_number(parseFloat(value), get_number_format(this.get_currency()), this.df.precision || null);
        return isNaN(parseFloat(value)) ? "" : formatted_value;
    }
});
...
frappe.ui.form.ControlDate = frappe.ui.form.ControlData.extend({
    ...
    set_datepicker: function() {
        this.datepicker_options.dateFormat = (frappe.boot.sysdefaults.date_format || 'yyyy-mm-dd').replace("yyyy", "yy")
...
frappe.ui.form.ControlDatetime = frappe.ui.form.ControlDate.extend({
    set_datepicker: function() {
        ...
        this.datepicker_options.dateFormat = (frappe.boot.sysdefaults.date_format || 'yy-mm-dd').replace('yyyy', 'yy');
...
frappe.ui.form.ControlButton = frappe.ui.form.ControlData.extend({
    make_input: function() {
        var me = this;
        this.$input = $('<button class="btn btn-default">').prependTo(me.input_area).on("click", function() {
            me.onclick();
        });
        this.input = this.$input.get(0);
        this.set_input_attributes();
    ...
    set_label: function() {
        ...
        this.$input && this.$input.html((this.df.icon ? ('<i class="' + this.df.icon + ' icon-fixed-width"></i> ') : "") + __(this.df.label));
    }
});
frappe.ui.form.ControlAttach = frappe.ui.form.ControlData.extend({
    make_input: function() {
        var me = this;
        this.$input = $('<button class="btn btn-default">').html(__("Upload")).prependTo(me.input_area).on("click", function() {
            me.onclick();
        });
   ...
   <a class="close">&times;</a></div>').prependTo(me.input_area).toggle(false);
    ...
    set_input: function(value, dataurl) {
        ...
        if (this.value) {
            ...
            this.$value.toggle(true).find(".attached-file").html(this.value).attr("href", dataurl || this.value);
        } else {
...
frappe.ui.form.ControlSelect = frappe.ui.form.ControlData.extend({
   ...
   <i class='icon-plus'></i></button>").click(function() {
...
frappe.ui.form.ControlLink = frappe.ui.form.ControlData.extend({
   ...
   <span class="link-field-btn" style="display: table-cell">\
    ...
    validate: function(value, callback) {
        ...
        this.frm.script_manager.validate_link_and_fetch(this.df, this.get_options(), this.docname, value, callback);
    },
});
frappe.ui.form.ControlDynamicLink = frappe.ui.form.ControlLink.extend({
    get_options: function() {
        ...
        if (!options) {
            msgprint(__("Please set {0} first", [frappe.meta.get_docfield(this.df.parent, this.df.options, this.docname).label]));
        }
        return options;
    },
});
frappe.ui.form.ControlCode = frappe.ui.form.ControlText.extend({
    make_input: function() {
        this._super();
        $(this.input_area).find("textarea").css({
            "height": "400px",
...
frappe.ui.form.LinkSelector = Class.extend({
    ...
    search: function(btn) {
       ...
       <span class="text-muted">%(values)s</span></p>', {
                    ...
                    $('<div class="alert alert-info">' + __("No Results") + (frappe.model.can_read(me.doctype) ? ('. <a class="new-doc">' + __("Make a new") + " " + __(me.doctype) + "</a>") : '') + '</div>').appendTo(parent).find(".new-doc").click(function() {
...
frappe.ui.form.Grid = Class.extend({
    init: function(opts) {
        ...
        this.template = null;
        if (this.frm.meta.__form_grid_templates && this.frm.meta.__form_grid_templates[this.df.fieldname]) {
  ...
  <div class="form-grid">\
   ...
   <div class="panel-body" style="padding-top: 7px;">\
    ...
    <div class="small grid-footer">\
     <a href="#" class="grid-add-row pull-right" style="margin-left: 10px;">+ ' + __("Add new row") + '.</a>\
     <a href="#" class="grid-add-multiple-rows pull-right hide" style="margin-left: 10px;">+ ' + __("Add multiple rows") + '.</a>\
     <span class="text-muted pull-right" style="margin-right: 5px;">' + __("Click on row to view / edit.") + '</span>\
     <div class="clearfix"></div>\
    </div>\
   </div>\
  </div>\
  </div>').appendTo(this.parent).attr("data-fieldname", this.df.fieldname);
    ...
    data_rows_are_same: function(data) {
        if (this.grid_rows) {
            var same = data.length == this.grid_rows.length && this.display_status == this.last_display_status && this.frm.docname == this.last_docname && !$.map(this.grid_rows, function(g, i) {
    ...
    set_multiple_add: function(link, qty) {
        ...
        $(this.wrapper).find(".grid-add-multiple-rows").removeClass("hide").on("click", function() {
            new frappe.ui.form.LinkSelector({
...
frappe.ui.form.GridRow = Class.extend({
    ...
    make: function() {
        ...
        this.row = $('<div class="data-row" style="min-height: 26px;"></div>').appendTo(this.wrapper).on("click", function() {
            me.toggle_view();
            return false;
        });
    ...
    set_row_index: function() {
        if (this.doc) {
            this.wrapper.attr("data-idx", this.doc.idx).find(".row-index").html(this.doc.idx)
        }
    },
    remove: function() {
    ...
    make_static_display: function() {
        var me = this;
        this.row.empty();
        $('<div class="col-xs-1 row-index">' + (this.doc ? this.doc.idx : "#") + '</div>').appendTo(this.row);
        if (this.grid.template) {
            $('<div class="col-xs-10">').appendTo(this.row).html(frappe.render(this.grid.template, {
     ...
     <span class="grid-delete-row" style="padding: 4px;">\
      <i class="icon icon-trash"></i></span>\
            ...
            if ($col.width() < 50) {
                ...
                $col.toggle(true);
                $col.find(".grid-insert-row").click(function() {
                    me.insert();
                    return false;
                });
                $col.find(".grid-delete-row").click(function() {
                    me.remove();
                    return false;
                });
            }
    ...
    add_visible_columns: function() {
        ...
        for (var ci in this.static_display_template) {
            ...
            var txt = this.doc ? frappe.format(this.doc[df.fieldname], df, null, this.doc) : __(df.label);
            if (this.doc && df.fieldtype === "Select") {
                txt = __(txt);
            }
            var add_class = (["Text", "Small Text"].indexOf(df.fieldtype) === -1) ? " grid-overflow-ellipsis" : " grid-overflow-no-ellipsis";
            add_class += (["Int", "Currency", "Float"].indexOf(df.fieldtype) !== -1) ? " text-right" : "";
            $col = $('<div class="col col-xs-' + colsize + add_class + ' grid-static-col"></div>').html(txt).attr("data-fieldname", df.fieldname).data("df", df).appendTo(this.row)
            if (!this.doc) $col.css({
                "font-weight": "bold"
            })
        }
    ...
    make_static_display_template: function() {
        ...
        for (var ci in this.docfields) {
            ...
            if (!df.hidden && df.in_list_view && this.grid.frm.get_perm(df.permlevel, "read") && !in_list(frappe.model.layout_fields, df.fieldtype)) {
                var colsize = 2;
                switch (df.fieldtype) {
                    case "Text":
                    case "Small Text":
    ...
    toggle_view: function(show, callback) {
        ...
        this.fields = [];
        this.fields_dict = {};
        this.show = show === undefined ? show = !this.show : show
        ...
        if (this.show) {
            if (!this.form_panel) {
                this.form_panel = $('<div class="panel panel-warning" style="display: none;"></div>').insertBefore(this.divider);
            }
            this.render_form();
    ...
    toggle_add_delete_button_display: function($parent) {
        $parent.find(".grid-delete-row, .grid-insert-row, .grid-append-row").toggle(this.grid.is_editable());
    },
   ...
   <div class="panel-body">\
    ...
    set_form_events: function() {
        var me = this;
        this.form_panel.find(".grid-delete-row").click(function() {
            me.remove();
            return false;
        })
        this.form_panel.find(".grid-insert-row").click(function() {
            me.insert(true);
            return false;
        })
        this.form_panel.find(".grid-append-row").click(function() {
    ...
    refresh_field: function(fieldname) {
        ...
        if ($col.length) {
            $col.html(frappe.format(this.doc[fieldname], frappe.meta.get_docfield(this.doc.doctype, fieldname, this.frm.docname), null, this.frm.doc));
        }
...
frappe.ui.form.Attachments = Class.extend({
   ...
   <p class="text-muted small">' + __("You can also drag and drop attachments") + '</div>\
  </div>').appendTo(this.parent);
...
frappe.ui.form.Comments = Class.extend({
    ...
    make: function() {
        ...
        this.list = $('<div class="comments"></div>').appendTo(this.parent);
   ...
   <div class="media-body">\
    ...
    <div class="text-right" style="margin-top: 10px">\
     <button class="btn btn-default btn-go btn-sm">\
      <i class="icon-ok"></i> ' + __("Add comment") + '</button>\
        ...
        this.button = this.row.find(".btn-go").click(function() {
            me.add_comment(this);
        });
    },
    refresh: function() {
        ...
        comments = [{
            ...
            "comment_by": this.frm.doc.owner,
            "creation": this.frm.doc.creation
        }].concat(this.get_comments());
    ...
    </div>', c)).appendTo(me.list).on("click", ".close", function() {
    ...
    insert_comment: function(comment_type, comment, btn) {
        ...
        return frappe.call({
            ...
            callback: function(r) {
                if (!r.exc) {
                    me.frm.get_docinfo().comments = me.get_comments().concat([r.message]);
                    me.frm.toolbar.show_infobar();
                    me.input.val("");
                    me.refresh();
                }
    ...
    delete_comment: function(name) {
        ...
        return frappe.call({
            ...
            callback: function(r) {
                if (!r.exc) {
                    me.frm.get_docinfo().comments = $.map(me.frm.get_docinfo().comments, function(v) {
...
frappe.ui.form.LinkedWith = Class.extend({
    ...
    make_dialog: function() {
        ...
        if (!links) {
            this.dialog.fields_dict.list.$wrapper.html("<div class='alert alert-warning'>" + this.frm.doctype + ": " + (this.linked_with ? __("Not Linked to any record.") : __("Not enough permission to see links.")) + "</div>")
            return;
        }
        this.dialog.onshow = function() {
                ...
                callback: function(r) {
                    ...
                    if (keys(r.message || {}).length) {
                        $.each(keys(r.message).sort(), function(i, doctype) {
                            ...
                            var body = $('<div class="panel-body">').appendTo(wrapper).css({
                                "padding-top": "0px",
                                "padding-bottom": "0px"
                            });
                            $.each(r.message[doctype], function(i, d) {
                                d.doctype = doctype;
                                listview.render($("<div>").appendTo(body), d, me);
                            })
                        })
                    } else {
...
frappe.ui.form.States = Class.extend({
    ...
    make: function() {
        this.parent = this.frm.appframe.parent.find(".workflow-button-area").empty().removeClass("hide");
   ...
   <span class="caret"></span></button>').appendTo(this.parent).dropdown();
        this.dropdown = $('<ul class="dropdown-menu">').insertAfter(this.workflow_button);
        this.help_btn = $('<button class="btn btn-default"><i class="icon-question-sign"></i></button').insertBefore(this.workflow_button);
        this.setup_help();
        this.bind_action();
    },
    setup_help: function() {
    ...
    refresh: function() {
        ...
        if (state) {
            ...
            if (state_doc) {
                this.workflow_button.find('i').removeClass().addClass("icon-white").addClass("icon-" + state_doc.icon);
    ...
    show_actions: function(state) {
     ...
     <i class="icon icon-%(icon)s"></i> %(action)s</a></li>', d)).appendTo($ul);
            }
        });
        var is_final = !$ul.find("li").length;
        this.workflow_button.prop('disabled', is_final);
    ...
    bind_action: function() {
        ...
        this.dropdown.on("click", "[data-action]", function() {
            ...
            if (new_docstatus == 1 && me.frm.doc.docstatus == 0) {
                ...
                msgprint(__("Document Status transition from ") + me.frm.doc.docstatus + " " + __("to") +
        ...
        if (!me.dialog) {
            me.dialog = new frappe.ui.Dialog({
                ...
                fields: [{
                    ...
                    options: 'User',
                    label: __("Assign To"),
                    description: __("Add to To Do List Of"),
                    reqd: true
                }, {
                    fieldtype: 'Data',
...
frappe.ui.form.PrintPreview = Class.extend({
   ...
   <div class="print-preview">\
  ...
  </div>').appendTo(this.frm.layout_main).toggle(false);
    },
    bind_events: function() {
        var me = this;
        ...
        }).prop("checked", cint((frappe.model.get_doc(":Print Settings", "Print Settings") || {
            with_letterhead: 1
        }).with_letterhead) ? true : false);
        ...
        this.wrapper.find(".btn-download-pdf").click(function() {
            if (!me.is_old_style()) {
                var w = window.open("/api/method/frappe.templates.pages.print.download_pdf?" + "doctype=" + encodeURIComponent(me.frm.doc.doctype) + "&name=" + encodeURIComponent(me.frm.doc.name) + "&format=" + me.selected_format() + "&no_letterhead=" + (me.with_letterhead() ? "0" : "1"));
                if (!w) {
    ...
    new_page_preview: function(printit) {
        var me = this;
        this.get_print_html(function(html) {
            var w = window.open("/print?" + "doctype=" + encodeURIComponent(me.frm.doc.doctype) + "&name=" + encodeURIComponent(me.frm.doc.name) + (printit ? "&trigger_print=1" : "") + "&format=" + me.selected_format() + "&no_letterhead=" + (me.with_letterhead() ? "0" : "1"));
            if (!w) {
                msgprint(__("Please enable pop-ups"));
                return;
            }
    ...
    print_old_style: function() {
        frappe.require("/assets/js/print_format_v3.min.js");
        _p.build(this.print_sel.val(), _p.go, !this.with_letterhead());
    },
    new_page_preview_old_style: function() {
        frappe.require("/assets/js/print_format_v3.min.js");
        _p.build(this.print_sel.val(), _p.preview, !this.with_letterhead());
    },
